...
export const heroData = {
	title: "Desa Jadimulya Anu Leuwih Waluya",
	subtitle:
	...
	actions: [{ label: "Jelajahi Desa", href: "#potensi" }],
};
...
export const homepageFeatures: FeatureItem[] = [
	{
		...
		description:
			"Produk kerajinan tangan khas Jadimulya yang menggabungkan teknik tradisional dengan desain modern.",
	...
	},
	{
		...
		description:
			"Destinasi air terjun alami di tengah pegunungan yang asri dan sejuk.",
	...
	},
	{
		...
		description:
			"Kopi pilihan diproses secara tradisional dari lereng perbukitan Desa Jadimulya.",
...
export const homepageNews: NewsItem[] = [
	{
		...
		date: "12 Mei 2024",
		description:
			"Pemerintah Desa Jadimulya menggelar Musyawarah Perencanaan Pembangunan Desa guna menyerap aspirasi warga.",
		imageUrl: "/images/potensi-umkm.jpg",
	},
	{
		id: "news-2",
		...
		date: "08 Mei 2024",
		description:
			"Lebih dari 200 balita di Desa Jadimulya mendapatkan layanan kesehatan gratis dalam rangka penguatan sistem imun desa.",
		imageUrl: "/images/potensi-wisata.jpg",
	},
	{
		id: "news-3",
		...
		date: "02 Mei 2024",
		description:
			"Kini warga Jadimulya dapat mengakses ribuan koleksi buku digital secara gratis untuk meningkatkan wawasan.",
		imageUrl: "/images/potensi-kopi.jpg",
	},
];
