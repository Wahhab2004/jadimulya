...
export default function Footer() {
  return (
    <footer className="border-t border-white-800 bg-white-950 text-black-900">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed text-slate-400">
              Jl. Raya No.254, Jadimulya, Kec. Langkaplancar, Kab. Pangandaran,
              Jawa Barat 46391
            </p>
            <div className="space-y-1.5 text-xs text-slate-400">
              <p>
                <strong className="text-black-200">Email:</strong>{" "}
                pemdes@jadimulya.desa.id
              </p>
              <p>
                <strong className="text-black-200">Telepon:</strong> (0265)
                123-4567
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-4 space-y-2 text-xs text-black-300">
              <div className="flex justify-between border-b border-white-800/80 pb-1.5">
            ...
            <div className="mt-5 rounded-2xl border border-sky-500/20 bg-sky-950/40 p-3.5 backdrop-blur-sm">
              ...
              <p className="mt-1 text-[11px] text-black-400 leading-normal">
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-black-800/80 pt-8 sm:flex-row text-xs text-slate-500">
          <p>© 2026 Pemerintah Desa Jadimulya. Seluruh Hak Cipta Dilindungi.</p>
          <div className="flex gap-6">
            <Link
              href="https://share.google/vHtKNspBM5OCqib6O"
			  target="_blank"
